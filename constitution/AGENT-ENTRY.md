...
- **Platform IT Expert v1.3.4** — Skills 1–17 ACTIVE; Skill 17 Governed Cloud Delivery Engineering activated by FA-049. Operational clarifications require Docker Azure CLI proof, real-container lifecycle evidence for applicable PRs, deterministic-first token efficiency, static-first focused validation, and commit-bound C-059/C-065 preparation without changing Decision Space. Skill activation does not itself grant cloud, deployment, spend, DNS, Production, or Work Contract authority.
