...
| Amendment 5 Order 3 canonical contract publication | IN PROGRESS — `GOA-GOAL-005-INST-005-08` issued for canonical BP plus private WBE/PR/DMA and CE-coverage contracts; acceptance and `CR-GOAL-005-INST-005-12` remain pending; owner attestations and INST-010 generation are not yet authorized |
