...
| WC-104 end-to-end Docker runner supply | IN-PROGRESS CHECKPOINT - Founder-authorized milestones through `1b1bae68` establish four canonical narrow runner identities, one serialized GHCR producer path, digest/provenance-verifying consumers, exact precheck evidence reuse, early atomic output preflight, strict hosted measurement validation and catalog-owned execution across local preparation, PR CI and main/release CI. Local Docker evidence passes the 59-test catalog/precheck contract slice plus prior component and validation-control suites. Remaining work includes hosted three-sample PR/main evidence, complete exact-tuple reuse proof, full gate equivalence, rollback rehearsal, exact ledger closure, author review, PR submission and Founder review/merge; no hosted or completion claim is made. |
