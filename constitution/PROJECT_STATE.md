...
**State Schema:** 2.0.0
**State Revision:** 164
**Last Updated:** 2026-09-15 (WC-089 EXACT-SEVEN RELEASE CHECKPOINT)
...
| WC-096 conversational customer portal | IN-PROGRESS CHECKPOINT - Founder-authorized contract `d231a8ae` consolidates Demo feedback DF-001 through DF-009. Milestones `6d050b6d`, `82b64da3`, `2cf6cac5` and `d327c0c1` deliver BP-owned canonical Marketplace routes/intents, authoritative versioned disclosure with explicit acceptance and Terms, idempotent evidence-first Trial/Hire continuation to an initial relationship, generated clients, one customer route-group shell, client navigation, an accessible persisted icon rail and a direct My Agents dashboard backed by one authoritative aggregate with server-owned resume targets. Existing affected Docker checks pass 28 BP tests and 62 Web tests; the dashboard milestone additionally passes 13 focused BP tests, 5 focused Web tests and TypeScript compilation. Trial entitlement/payment remain explicit later lifecycle steps. Contextual interaction API, persistent conversation, full qualification and PR submission remain; no deployment, customer traffic, UAT, Production, PR approval or merge is claimed. |
