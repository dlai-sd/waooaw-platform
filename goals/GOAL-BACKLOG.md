...
| GOAL-005 | Agent Employment Experience Program — one constitutional relationship across discovery, hire, work, lifecycle, multiple agents, and organizational delegation | **G-2 UNDERSTANDING APPROVED** — R-032; G-3 authorized; no implementation authorization | WC-055; AE-01→AE-06 remain outcome epics | — |
