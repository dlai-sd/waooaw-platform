...
| GOAL-005 | Agent Employment Experience Program — one constitutional relationship across discovery, hire, work, lifecycle, multiple agents, and organizational delegation | **REGISTERED** — Founder authorized INST-013 for G-2 Understanding; no implementation authorization | Not assigned; AE-01→AE-06 are outcome epics | — |
