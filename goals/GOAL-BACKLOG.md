...
| GOAL-005 | Agent Employment Experience Program — one constitutional relationship across discovery, hire, work, lifecycle, multiple agents, and organizational delegation | **REGISTERED / BLOCKED** — CB-001: INST-013 registry status contradiction; no implementation authorization | Not assigned; AE-01→AE-06 are outcome epics | — |
