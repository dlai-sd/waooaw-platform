...
| GOAL-005 | Agent Employment Experience Program — one constitutional relationship across discovery, hire, work, lifecycle, multiple agents, and organizational delegation | **G-3 BLOCKED** — R-033 CHALLENGE; CB-002 awaits Founder adjudication of missing G-10 Classification record type; no implementation authorization | WC-055; AE-01→AE-06 remain outcome epics | — |
