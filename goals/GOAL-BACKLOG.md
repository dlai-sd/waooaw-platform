...
| GOAL-005 | Agent Employment Experience Program — one constitutional relationship across discovery, hire, work, lifecycle, multiple agents, and organizational delegation | **G-2 UNDERSTANDING IN REVIEW** — GUR-GOAL-005-INST-013-01 produced; no implementation authorization | WC-055; AE-01→AE-06 remain outcome epics | — |
