...
public static class AgentAdmissionModelConfiguration
{
    public static void Configure(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AgentAdmission>(entity =>
        {
            ...
            entity
                .Property(value => value.ProfessionalTypeId)
            ...
            entity
                .Property(value => value.SubmitterSubjectId)
                .HasColumnName("submitter_subject_id");
            entity
            ...
            entity
                .Property(value => value.AdmissionContentDigest)
                .HasColumnName("admission_content_digest");
        ...
        modelBuilder.Entity<AgentAdmissionRevision>(entity =>
        {
            ...
            entity
                .Property(value => value.ContractSchemaVersion)
                .HasColumnName("contract_schema_version");
            entity
                .Property(value => value.AdmissionContentDigest)
                .HasColumnName("admission_content_digest");
            entity
                .Property(value => value.AdmissionContentJson)
                .HasColumnName("admission_content")
                .HasColumnType("jsonb");
            entity.Property(value => value.ActorSubjectId).HasColumnName("actor_subject_id");
            entity
                .Property(value => value.PredecessorRevisionId)
                .HasColumnName("predecessor_revision_id");
            entity.Property(value => value.CreatedAt).HasColumnName("created_at");
            Parent<AgentAdmissionRevision>(
                entity,
                value => new { value.TenantId, value.AdmissionId }
            );
            entity
                .HasOne<AgentAdmissionRevision>()
                .WithMany()
        ...
        modelBuilder.Entity<AgentAdmissionValidation>(entity =>
        {
            ...
            Parent<AgentAdmissionValidation>(
                entity,
                value => new { value.TenantId, value.AdmissionId }
            );
        });
        ...
        modelBuilder.Entity<AgentAdmissionFinding>(entity =>
        {
            ...
            entity
                .Property(value => value.ConstitutionalBasis)
            ...
            entity.Property(value => value.CreatedAt).HasColumnName("created_at");
            entity
                .HasOne<AgentAdmissionValidation>()
                .WithMany()
        ...
        modelBuilder.Entity<AgentAdmissionAssertion>(entity =>
        {
            ...
            Parent<AgentAdmissionAssertion>(
                entity,
                value => new { value.TenantId, value.AdmissionId }
            );
        });
        ...
        modelBuilder.Entity<AgentAdmissionTransition>(entity =>
        {
            ...
            Parent<AgentAdmissionTransition>(
                entity,
                value => new { value.TenantId, value.AdmissionId }
            );
        });
        ...
        modelBuilder.Entity<AgentAdmissionIdempotency>(entity =>
        {
            ...
            Parent<AgentAdmissionIdempotency>(
                entity,
                value => new { value.TenantId, value.AdmissionId }
            );
        });
        ...
        modelBuilder.Entity<AgentAdmissionOutbox>(entity =>
        {
            ...
            entity
                .Property(value => value.PayloadJson)
            ...
            Parent<AgentAdmissionOutbox>(
                entity,
                value => new { value.TenantId, value.AdmissionId }
            );
            entity
                .HasOne<AgentAdmissionTransition>()
                .WithMany()
