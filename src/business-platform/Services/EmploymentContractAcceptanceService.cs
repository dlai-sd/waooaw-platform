...
{
    public const string ExplicitStatement =
        "I_CONFIRM_THE_ACCEPTED_DECISION_SPACE_AND_AUTHORITY_SCOPE";
}
...
)
{
    ...
    )
    {
        ...
        var contract =
            ...
            ?? throw new ContractIdentityMismatchException();
        ...
        if (existing is not null)
        {
            ...
            {
                throw new ConstitutionalActionDeniedException(
                    "The contract already has a different effective acceptance."
                );
            }
