...
|---|---|---|---|---|---|
| **WC-034** | Hybrid Web Application Shell | Next.js 14 PWA | ARCHITECTURE IN PROGRESS — IMPLEMENTATION UNAUTHORIZED | WC-057 · ADR-017 · IB-014 | Public, customer, and Founder application-shell architecture; Founder admin features remain gated |
...
| L5 Interface | Static home template + provisional relationship PWA shell | ~20% | WC-034 architecture in progress; implementation unauthorized |
