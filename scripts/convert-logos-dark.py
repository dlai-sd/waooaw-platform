...
def make_dark_variant(input_path: str, output_path: str, name: str) -> None:
    ...
    r, g, b, _alpha = data[:, :, 0], data[:, :, 1], data[:, :, 2], data[:, :, 3]
    lightness = (r + g + b) / 3.0
...
make_dark_variant(os.path.join(BRAND_DIR, "dlaisd-logo.png"), os.path.join(BRAND_DIR, "dlaisd-logo-dark.png"), "DLAISD")
make_dark_variant(os.path.join(BRAND_DIR, "yashus-logo.png"), os.path.join(BRAND_DIR, "yashus-logo-dark.png"), "Yashus")
print("Done.")
