...
| **11.5 Run Paid Advertising** | AI Runtime (Skill 11 PAID_ADVERTISING — ADR-026 agency model) | waooaw-ads-manager (MBM/MCC sub-account ops); meta-ads-mcp + google-ads-mcp using WAOOAW master account credentials; business.customer_ad_accounts + ad_spend_wallets + ad_spend_ledger (C-056 segregation); CE (ValidateAction with BudgetContext before every spend — C-043 ceiling + C-056 segregation check) |
