...
These Terms of Service ("**Terms**") constitute a legally binding agreement between you ("**Customer**", "**you**") and DLAI Satellite Data (OPC) Pvt Ltd ("**DLAISD**", "**we**", "**Company**") governing your access to and use of the WAOOAW platform at waooaw.com ("**Platform**").

By registering an account, subscribing to a service, or using the Platform in any capacity, you confirm that:

1. You have read, understood, and agree to be bound by these Terms
2. You are at least 18 years of age (or, for the Private Tutor service, you are the parent or legal guardian of the student)
3. You have the legal capacity to enter into contracts under the **Indian Contract Act, 1872**
4. If acting on behalf of an organisation, you are authorised to bind that organisation
...
- You may register using Google, Facebook, Apple OAuth, or your WhatsApp/mobile number
- You may maintain only one active account per mobile number

### 3.2 Account Responsibility
- You are responsible for maintaining the confidentiality of your account credentials
- You are responsible for all activity that occurs under your account
- You must notify us immediately of any unauthorised access at customersupport@dlaisd.com or +91 8888912344

### 3.3 Accurate Information
- You agree to provide accurate, current, and complete information at registration
- You agree to update this information if it changes
...
### 4.3 No Obligation
A free trial creates no obligation to subscribe. We will never charge your payment method without your explicit authorisation.
...
Services are offered on a monthly subscription basis. Current pricing is displayed on the Platform at the time of subscription. Prices include applicable GST at 18% (SAC Code: 9984).

### 5.2 Payment
- All payments are processed by **Razorpay** (Razorpay Software Pvt Ltd)
- Accepted payment methods: UPI, debit card, credit card, net banking
- By providing payment details, you authorise us to charge the applicable subscription fee on each renewal date
- Payment details are stored and processed by Razorpay in accordance with PCI-DSS standards. DLAISD does not store payment card details.

### 5.3 Renewal
- Subscriptions auto-renew monthly on the same date as the original subscription
- You will receive a renewal reminder via WhatsApp/email 5 days before renewal
- To cancel auto-renewal, use Settings → Subscription → "Pause or cancel" at least 24 hours before the renewal date

### 5.4 Pro-Rata Billing — Your Constitutional Right
Pro-rata billing on pause, cancellation, or Emergency Stop is **not a commercial policy — it is your constitutional right (C-038)**. The constitutional framework mandates that billing is calculated strictly on a pro-rata basis from the moment of pause or termination. No minimum periods, no penalties, no forfeiture of work produced. This right cannot be removed by any future version of these Terms. See Refund Policy for the complete refund schedule.

### 5.4 GST Invoices
GST-compliant invoices are issued for every payment. Invoices are available in your account portal and will be sent to your registered email. Our GSTIN is 27AAKCD8188R1ZH.
...
## 6A. Your Constitutional Bill of Rights

The WAOOAW Constitutional Framework (Article IX) grants you the following rights. **No right listed here may be waived by contract, commercial agreement, or platform configuration.**
...
Your use of the Platform is subject to our **Privacy Policy** (available at waooaw.com/privacy), which is incorporated into these Terms by reference. By accepting these Terms, you also accept the Privacy Policy.

---

## 10. Third-Party Services

The Platform integrates with third-party services (Google, Meta/WhatsApp, Razorpay, Microsoft Azure). Your use of these third-party services is subject to their respective terms and privacy policies. DLAISD is not responsible for the practices, terms, or availability of third-party services.
...
1. Use the Platform for any illegal purpose or in violation of any Indian or applicable law
2. Upload, transmit, or cause the Platform to process content that is defamatory, obscene, threatening, or violates the rights of any third party
3. Attempt to gain unauthorised access to any part of the Platform or any other user's account
4. Introduce malware, viruses, or any malicious code into the Platform
5. Use the Platform in any way that imposes a disproportionate load on our infrastructure
6. Scrape, crawl, or extract data from the Platform by automated means
7. Use the Platform to violate any person's privacy or data protection rights

Violation of any prohibited activity may result in immediate account suspension without refund.
...
1. **No consequential liability**: DLAISD shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including loss of profits, loss of data, or business interruption, arising from your use of the Platform.

2. **Aggregate cap**: DLAISD's total liability to you for any claim arising from these Terms or the Platform shall not exceed the total subscription fees paid by you to DLAISD in the **3 months immediately preceding** the event giving rise to the claim.
...
You agree to indemnify, defend, and hold harmless DLAISD, its directors, officers, employees, and agents from and against any claims, damages, losses, liabilities, costs, and expenses (including legal fees) arising from:
...
You may terminate your account at any time through Settings → Account → "Close account". Termination takes effect at the end of the current billing period. Prorated refunds apply as set out in the Refund Policy.
...
## 15A. Platform's Constitutional Rights
...
In the event of any dispute, claim, or controversy arising from or relating to these Terms or the Platform, the parties agree to:

1. **Informal resolution**: First attempt to resolve the dispute informally by contacting customersupport@dlaisd.com. We will respond within 10 working days.
2. **Grievance Officer**: If not resolved, escalate to the Grievance Officer (Yogesh Khandge, yogesh.khandge@dlaisd.com) within 30 days.
3. **Arbitration**: If still unresolved, the dispute shall be referred to a sole arbitrator appointed by mutual agreement, under the **Arbitration and Conciliation Act, 1996**. The seat of arbitration shall be Pune, Maharashtra. The language of arbitration shall be English.
4. **Jurisdiction**: Courts of competent jurisdiction in **Pune, Maharashtra** shall have exclusive jurisdiction over matters that cannot be resolved by arbitration.

### 16.3 Consumer Rights
Nothing in this clause affects your statutory rights under the **Consumer Protection Act, 2019**, including the right to approach the National Consumer Disputes Redressal Commission (NCDRC) or appropriate State/District Consumer Disputes Redressal Commission.
...
These Terms, together with the Privacy Policy and Refund Policy, constitute the entire agreement between you and DLAISD with respect to the Platform, superseding all prior agreements.
...
### 17.5 Amendments
We may modify these Terms with 15 days' advance notice for material changes and 3 days' notice for minor changes. Continued use after the effective date constitutes acceptance.

### 17.6 Language
The English version of these Terms is authoritative. Hindi translations are provided for convenience only.

---

## 18. Contact

**Customer Support:** customersupport@dlaisd.com | +91 8888912344
**Legal and Technology:** technology@dlaisd.com
**Registered Office:** DLAI Satellite Data (OPC) Pvt Ltd, C8, Everest Heights, Park Road, Viman Nagar, Pune 411014, Maharashtra, India
