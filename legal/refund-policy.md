...
This Refund Policy ("**Policy**") governs all refund, cancellation, and dispute claims for subscriptions and services purchased on the WAOOAW platform ("**Platform**"), operated by DLAI Satellite Data (OPC) Pvt Ltd ("**DLAISD**").
...
- Settings → Subscription → "Pause or cancel"
- Contacting customersupport@dlaisd.com
...
### 4.1 General Subscription Refunds

| When you cancel | Refund |
|---|---|
| Within **24 hours** of the first paid subscription charge (new subscriber only) | 100% of the charge refunded |
| Day 2 – Day 15 of the billing month | Pro-rata refund for remaining unused days |
| Day 16 – end of billing month | No refund — service has been substantially delivered |
| Referral credit applied to your account | Referral credit is non-refundable in cash; returned to your account credit balance on cancellation |

**Pro-rata calculation:**
```
Refund Amount = (Monthly fee ÷ Days in billing month) × Remaining days
```

*Example: Monthly fee ₹1,499. Cancellation on Day 8 of a 30-day month. Remaining days = 22.*
*Refund = (₹1,499 ÷ 30) × 22 = ₹1,099 (rounded to nearest rupee)*

GST (18%) is included in refund calculations. The GST component of the refund will be reversed on the original invoice.

### 4.2 Cooling-Off Period (Consumer Protection Act 2019)
New subscribers are entitled to a **24-hour cooling-off period** from the first paid charge. A 100% refund will be issued without question if requested within this period.

---

## 5. Service Disruption Refunds

### 5.1 Platform Outage
If the WAOOAW Platform is unavailable for more than **8 continuous hours** in a calendar month due to reasons within DLAISD's control:

- 1 day of subscription credit per 8 hours of downtime (up to 5 days per month)
...
- If the failure is confirmed, we will issue a pro-rata credit or refund for the affected period
...
> **All student session data (conversation transcripts, learning records, performance assessments) for the associated student(s) will be automatically and irrevocably deleted within 7 days of subscription end.**

This is not optional and cannot be deferred by any request, commercial arrangement, or technical constraint. It is mandated by C-060 of the constitutional framework (Minor Student Protection — LAW) and the DPDPA 2023 Section 9 (children's data). The parent will receive a confirmation notice when deletion is complete.

If you wish to retain your child's learning records, you must export them via the parent portal **before** the subscription ends. Exports are available in the portal at any time during an active subscription.
...
**Contact:** customersupport@dlaisd.com | +91 8888912344 (WhatsApp)

### 8.2 Processing Time

| Refund type | Processing time |
|---|---|
| 24-hour cooling-off refund | 2 working days |
| Pro-rata refund | 5–7 working days |
| Service disruption credit | Applied to next billing cycle within 48 hours of confirmation |
| Disputed charge (chargeback investigation) | 10–15 working days |

Refunds are returned to the original payment method (UPI, card, net banking) via Razorpay. DLAISD does not issue cash or cheque refunds.

### 8.3 GST Refund
The GST component of any refund will be reversed through a Credit Note issued by DLAISD in compliance with the **GST Act, 2017 (Section 34)**. A Credit Note will be sent to your registered email.
...
1. Contact customersupport@dlaisd.com within **30 days** of the disputed charge
2. Include your registered contact details and the Razorpay payment ID (found in your invoice)
3. We will investigate and respond within 5 working days
4. If the charge is confirmed as incorrect, a full refund will be issued within 7 working days

If you initiate a chargeback with your bank without first contacting us, we reserve the right to suspend your account pending resolution of the dispute.

---

## 10. Consumer Rights

This Policy does not affect your statutory rights under the **Consumer Protection Act, 2019**. If you are not satisfied with our refund decision, you may approach:

- **Consumer Helpline:** 1800-11-4000 (National Consumer Helpline)
- **E-Daakhil Portal:** edaakhil.nic.in (online consumer complaint filing)
- **District Consumer Disputes Redressal Commission** in your jurisdiction
...
We may update this Refund Policy from time to time. Material changes will be notified via in-platform notice and registered email at least **15 days** before taking effect. Continued use after the effective date constitutes acceptance.

---

## 12. Contact

**Customer Support:** customersupport@dlaisd.com | +91 8888912344 (WhatsApp + voice)
