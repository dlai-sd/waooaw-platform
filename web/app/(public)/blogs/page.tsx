...
export const metadata: Metadata = publicMetadata(
  'Insights | WAOOAW',
  'Research and practical guidance about governed digital professionals.',
  '/blogs'
);

export default function BlogsPage() {
  return (
    <div className="public-document article-index">
      <header>
        <p className="eyebrow">Research and guidance</p>
        <h1>Insights</h1>
        <p>Practical thinking about governed autonomy, evidence, and professional work.</p>
      </header>
