...
export const metadata = publicMetadata(
  'WAOOAW | Governed digital professionals',
  'Employ a governed digital professional with visible scope, reviewable work, and control that remains yours.',
  '/'
);
    ...
    <div className="public-home">
      ...
      <div className="public-intro public-intro-wc078">
        <section className="public-hero">
          ...
          <div className="command-row">
            <Link className="primary-link" href="/professionals">
              Meet a professional <ArrowRight aria-hidden="true" size={18} />
            </Link>
      ...
      <section className="public-section professionals-section" aria-labelledby="expert-professionals-title">
        <div className="section-heading">
          ...
          <h2 id="expert-professionals-title">{messages.expertProfessionals}</h2>
          <p>{messages.expertDescription}</p>
        </div>
        <PublicCatalogue compact professionals={professionals.slice(0, 3)} />
        <Link className="text-command" href="/professionals">
          {messages.browseProfessionals} <ArrowRight aria-hidden="true" size={18} />
        </Link>
      </section>
      ...
      <section className="public-section trust-journey" aria-labelledby="trust-journey-title">
        <div>
          ...
          <h2 id="trust-journey-title">{messages.trustJourney}</h2>
      ...
      <section className="public-section final-action">
        <p className="eyebrow">A professional relationship you can inspect</p>
        <h2>Begin with visible scope, honest limits, and control that stays with you.</h2>
        <div className="command-row">
          <Link className="primary-link" href="/professionals">
            Meet a professional <ArrowRight aria-hidden="true" size={18} />
          </Link>
      ...
      <section className="platform-dna" aria-labelledby="platform-dna-title">
        <p className="eyebrow">Platform DNA</p>
        <h2 id="platform-dna-title">Built through a connected institutional lineage.</h2>
        <dl>
          <div>
            <dt>Yashus</dt>
