...
export const metadata: Metadata = publicMetadata(
  'Digital professionals | WAOOAW',
  'Explore governed digital professionals, their outcomes, and their limits.',
  '/professionals'
);
  ...
  return (
    <div className="catalog-shell">
      <header className="catalog-header">
        <p className="brand">WAOOAW PROFESSIONALS</p>
        <h1>Choose a professional by the work you need.</h1>
        <p>
          Each publication shows approved outcomes and honest limits. It does not claim live availability or suitability
          for your business.
        </p>
      </header>
