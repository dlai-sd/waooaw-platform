...
const targets = [
  [
    ...
    [
      'instanceOfAcceptSkillPayloadV1',
      'AcceptSkillPayloadV1FromJSON',
      'instanceOfDeferSkillPayloadV1',
      'DeferSkillPayloadV1FromJSON',
      'instanceOfSelectSkillPayloadV1',
      'SelectSkillPayloadV1FromJSON',
      'instanceOfUpdateSkillPayloadV1',
      'UpdateSkillPayloadV1FromJSON',
