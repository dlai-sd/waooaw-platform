...
const en = {
  ...
  signInDescription:
    'WAOOAW uses Keycloak to broker approved sign-in methods. Your access token is never exposed to this page.',
  existingAccount: 'Already have an account?',
  signIn: 'Log in',
  legalPrefix: 'By continuing, you agree to WAOOAW’s',
  terms: 'Terms of Service',
  legalAnd: 'and',
  privacy: 'Privacy Policy',
  resolvingTitle: 'Finishing your sign-in',
  resolvingDescription: 'We’re preparing your WAOOAW account.',
  signInRejected: 'We couldn’t complete your sign-in. Your account was not changed.',
  restartSignIn: 'Sign in again',
  freshSignInRequired: 'For your security, sign in again to continue. Your account was not changed.',
  continueSecurely: 'Continue securely',
  verificationSent: 'Enter the code sent to',
  verificationExpired: 'That verification code expired. Request a new code to continue.',
  registrationLost: 'This registration is no longer accessible. Sign in again to restart securely.',
  unavailable: 'We couldn’t complete your registration. Your account was not changed.',
  duplicate: 'Additional identity confirmation is required before this account can be completed.',
} as const;
...
const translations: Partial<Record<SupportedLocale, Partial<IdentityMessages>>> = {
  hi: {
    title: 'अपना WAOOAW खाता बनाएँ',
    displayName: 'आपका नाम',
    businessName: 'व्यवसाय का नाम',
    businessDomain: 'व्यवसाय का प्रकार',
    email: 'ईमेल पता',
    mobile: 'मोबाइल नंबर',
  ...
  mr: {
    title: 'तुमचे WAOOAW खाते तयार करा',
    displayName: 'तुमचे नाव',
    businessName: 'व्यवसायाचे नाव',
    businessDomain: 'व्यवसायाचा प्रकार',
    email: 'ईमेल पत्ता',
  ...
  ta: {
    title: 'உங்கள் WAOOAW கணக்கை உருவாக்குங்கள்',
    displayName: 'உங்கள் பெயர்',
    businessName: 'வணிகப் பெயர்',
    businessDomain: 'வணிக வகை',
  ...
  te: {
    title: 'మీ WAOOAW ఖాతాను సృష్టించండి',
    displayName: 'మీ పేరు',
    businessName: 'వ్యాపార పేరు',
    businessDomain: 'వ్యాపార రకం',
  ...
  kn: {
    title: 'ನಿಮ್ಮ WAOOAW ಖಾತೆಯನ್ನು ರಚಿಸಿ',
    displayName: 'ನಿಮ್ಮ ಹೆಸರು',
    businessName: 'ವ್ಯವಹಾರದ ಹೆಸರು',
    businessDomain: 'ವ್ಯವಹಾರದ ಪ್ರಕಾರ',
    email: 'ಇಮೇಲ್ ವಿಳಾಸ',
  ...
  gu: {
    title: 'તમારું WAOOAW ખાતું બનાવો',
    displayName: 'તમારું નામ',
    businessName: 'વ્યવસાયનું નામ',
    businessDomain: 'વ્યવસાયનો પ્રકાર',
    email: 'ઈમેલ સરનામું',
    mobile: 'મોબાઇલ નંબર',
    code: 'છ અંકનો કોડ',
  ...
  bn: {
    title: 'আপনার WAOOAW অ্যাকাউন্ট তৈরি করুন',
    displayName: 'আপনার নাম',
    businessName: 'ব্যবসার নাম',
    businessDomain: 'ব্যবসার ধরন',
    email: 'ইমেইল ঠিকানা',
    mobile: 'মোবাইল নম্বর',
    code: 'ছয় সংখ্যার কোড',
  ...
  ml: {
    title: 'നിങ്ങളുടെ WAOOAW അക്കൗണ്ട് സൃഷ്ടിക്കുക',
    displayName: 'നിങ്ങളുടെ പേര്',
    businessName: 'ബിസിനസിന്റെ പേര്',
    businessDomain: 'ബിസിനസിന്റെ തരം',
    email: 'ഇമെയിൽ വിലാസം',
    mobile: 'മൊബൈൽ നമ്പർ',
    code: 'ആറക്ക കോഡ്',
  ...
  pa: {
    title: 'ਆਪਣਾ WAOOAW ਖਾਤਾ ਬਣਾਓ',
    displayName: 'ਤੁਹਾਡਾ ਨਾਮ',
    businessName: 'ਕਾਰੋਬਾਰ ਦਾ ਨਾਮ',
    businessDomain: 'ਕਾਰੋਬਾਰ ਦੀ ਕਿਸਮ',
    email: 'ਈਮੇਲ ਪਤਾ',
    mobile: 'ਮੋਬਾਈਲ ਨੰਬਰ',
    code: 'ਛੇ ਅੰਕਾਂ ਦਾ ਕੋਡ',
  ...
  ur: {
    eyebrow: 'محفوظ رجسٹریشن',
    title: 'اپنا WAOOAW اکاؤنٹ بنائیں',
    signInDescription:
      'WAOOAW منظور شدہ سائن اِن طریقوں کے لیے Keycloak استعمال کرتا ہے۔ آپ کا رسائی ٹوکن اس صفحے پر ظاہر نہیں ہوتا۔',
    existingAccount: 'کیا آپ کا پہلے سے اکاؤنٹ ہے؟',
    signIn: 'سائن اِن کریں',
    displayName: 'آپ کا نام',
    businessName: 'کاروبار کا نام',
    businessDomain: 'کاروبار کی قسم',
    email: 'ای میل پتہ',
    mobile: 'موبائل نمبر',
    code: 'چھ ہندسوں کا کوڈ',
