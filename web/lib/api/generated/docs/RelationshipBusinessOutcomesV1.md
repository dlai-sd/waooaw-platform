# RelationshipBusinessOutcomesV1
...
| `items`             | [Array&lt;RelationshipBusinessOutcomeV1&gt;](RelationshipBusinessOutcomeV1.md)   |

## Example

```typescript
import type { RelationshipBusinessOutcomesV1 } from "";
...
const example = {
  ...
  items: null,
} satisfies RelationshipBusinessOutcomesV1;
...
const exampleParsed = JSON.parse(exampleJSON) as RelationshipBusinessOutcomesV1;
