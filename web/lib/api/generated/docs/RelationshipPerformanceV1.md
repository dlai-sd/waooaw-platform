...
| `current`           | [PerformanceReviewWindowV1](PerformanceReviewWindowV1.md)                        |
| `history`           | [Array&lt;PerformanceReviewWindowV1&gt;](PerformanceReviewWindowV1.md)           |

## Example

```typescript
import type { RelationshipPerformanceV1 } from "";
...
const example = {
  ...
  current: null,
  history: null,
} satisfies RelationshipPerformanceV1;
...
const exampleParsed = JSON.parse(exampleJSON) as RelationshipPerformanceV1;
