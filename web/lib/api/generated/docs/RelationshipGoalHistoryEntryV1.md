...
```typescript
import type { RelationshipGoalHistoryEntryV1 } from "";
...
const example = {
  ...
  changedAt: null,
  changeReason: null,
} satisfies RelationshipGoalHistoryEntryV1;
...
const exampleParsed = JSON.parse(exampleJSON) as RelationshipGoalHistoryEntryV1;
