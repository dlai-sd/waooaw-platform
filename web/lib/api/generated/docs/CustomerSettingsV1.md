...
| `availableSecurityActions` | Array&lt;string&gt;                                           |
| `updatedAt`                | Date                                                          |

## Example

```typescript
import type { CustomerSettingsV1 } from "";
...
const example = {
  ...
  availableSecurityActions: null,
  updatedAt: null,
} satisfies CustomerSettingsV1;
...
const exampleParsed = JSON.parse(exampleJSON) as CustomerSettingsV1;
