...
| `items`             | [Array&lt;RelationshipConfigurationStepV1&gt;](RelationshipConfigurationStepV1.md) |

## Example

```typescript
import type { RelationshipConfigurationV1 } from "";
...
const example = {
  ...
  lifecyclePhase: null,
  items: null,
} satisfies RelationshipConfigurationV1;
...
const exampleParsed = JSON.parse(exampleJSON) as RelationshipConfigurationV1;
