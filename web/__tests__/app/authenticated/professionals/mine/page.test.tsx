...
jest.mock('@/lib/i18n-server', () => ({
  getRequestI18n: async () => ({
    messages: {
      ...
      noProfessionalRelationships: 'No employed professionals yet.',
...
describe('MyProfessionalsPage', () => {
  ...
  it('renders each authoritative relationship as a separate expert workspace', async () => {
    mockListEmploymentRelationships.mockResolvedValue({
      schemaVersion: '1.0.0',
      producedAt: new Date('2026-08-10T12:00:00Z'),
      items: [
        {
          ...
          enabledSkillCount: 2,
          pendingSkillCount: 1,
          currentWorkSummary: 'Drafting local campaign plan',
        ...
        },
        {
          ...
          enabledSkillCount: 3,
          pendingSkillCount: 0,
          blockerSummary: 'Contract review is required.',
          performanceSummary: 'Renewals improved by 4%',
          billingSummary: 'Next charge ₹2,499',
