...
class TestSessionLifecycle:
    ...
    def mock_ce_service(self):
        ...
        mock_service.ValidateAction = AsyncMock(return_value={"decision": "Allow", "evidence_id": str(uuid.uuid4())})
        mock_service.RecordEvidence = AsyncMock(return_value={"evidence_id": str(uuid.uuid4())})
        return mock_service
